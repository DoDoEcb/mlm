...
Class MemberShipLevel extends My_Controller
{
	function __construct()
	{ 
		parent::__construct(); 
		$this->load->model("membershiplevelmodel","omodel");
	}
	
	public function Index()
	{     
		 $this->load->view("MemberShipLevel/index"); 
	}
	...
	{ 
		$this->load->view("MemberShipLevel/create");
	}
	...
	{
		$MemberShipLevel= $this->omodel->byId($id);
		$this->load->view("MemberShipLevel/edit",["MemberShipLevel"=> $MemberShipLevel]);
	}
