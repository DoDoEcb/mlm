					...
					<div role="form">  
						<div class="box-body">
						    <div class="form-group"> 
								 <?php echo form_hidden('Id',$Transaction->Id); ?>
							</div>
							<div class="form-group">
                                <?php echo form_label('Title', 'Title'); ?>
                                <?php echo form_input('Title',$Transaction->Title); ?>
                            </div>
							<div class="form-group"> 
							...
							<div class="form-group">
                                 ...
                                 <?php echo Ajaxdropdown('DebitLedgerAccountId',$this->omodel->ddlLedgerAccount(),$Transaction->DebitLedgerAccountId); ?>
                            </div>
							<div class="form-group">
                                <?php echo form_label('Debit Amount', 'DebitAmount'); ?>
                                <?php echo form_input('DebitAmount',$Transaction->DebitAmount); ?>
                            </div>
							<div class="form-group">
                                 <?php echo form_label('Credit Ledger Account', 'CreditLedgerAccountId'); ?> 
                                 <?php echo Ajaxdropdown('CreditLedgerAccountId',$this->omodel->ddlLedgerAccount(),$Transaction->CreditLedgerAccountId); ?>
                            </div>
							<div class="form-group">
                                <?php echo form_label('Credit Amount', 'CreditAmount'); ?>
                                <?php echo form_input('CreditAmount',$Transaction->CreditAmount); ?>
                            </div>
							<div class="form-group">
