...
<?php $modelname = "LedgerAccountType"; ?>
					...
					<div role="form">  
						<div class="box-body">
						    <div class="form-group"> 
								 <?php echo form_hidden('Id',$LedgerAccountType->Id); ?>
							</div>
							<div class="form-group">
                                <?php echo form_label('Title', 'Title'); ?>
                                <?php echo form_input('Title',$LedgerAccountType->Title); ?>
                            </div>
							<div class="form-group">
                                 <?php echo form_label('Parent', 'ParentId'); ?> 
                                 <?php echo Ajaxdropdown('ParentId',$this->omodel->ddlLedgerAccountType(),$LedgerAccountType->ParentId); ?>
                            </div>
