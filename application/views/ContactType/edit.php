					...
					<div role="form">  
						<div class="box-body">
						    <div class="form-group"> 
								 <?php echo form_hidden('Id',$ContactType->Id); ?>
							</div>
							<div class="form-group">
                                <?php echo form_label('Type Name', 'TypeName'); ?>
                                <?php echo form_input('TypeName',$ContactType->TypeName); ?>
                            </div>
