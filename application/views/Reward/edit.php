					...
					<div role="form">  
						<div class="box-body">
						    <div class="form-group"> 
								 <?php echo form_hidden('Id',$Reward->Id); ?>
							</div>
							<div class="form-group">
                                <?php echo form_label('Title', 'Title'); ?>
                                <?php echo form_input('Title',$Reward->Title); ?>
                            </div>
							<div class="form-group">
                                 ...
                                 <?php
									...
									?>
                                 <?php echo form_textarea($taDetail); ?>
                            </div>
							<div class="form-group">
                                <?php echo form_label('Picture', 'Picture'); ?>
                                <?php echo form_upload('Picture'); ?> 
                                <?php echo form_hidden('Picture1',$Reward->Picture); ?>
                            </div>
							<div class="form-group">
                                  <?php echo form_label('Is Active', 'IsActive'); ?>
                                  <?php echo form_checkbox('IsActive' ,true ,$Reward->IsActive); ?> 
                            </div>
