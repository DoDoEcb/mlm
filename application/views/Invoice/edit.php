					...
					<div role="form">  
						<div class="box-body">
							...
							<div class="form-group">
                                 ...
                                 <?php echo Ajaxdropdown('PaymentStatusId',$this->omodel->ddlPaymentStatus(),$Invoice->PaymentStatusId); ?>
                            </div>
							<div class="form-group">
                                <?php echo form_label('Last Emailed', 'LastEmailed'); ?>
                                <?php echo form_input('LastEmailed',$Invoice->LastEmailed); ?>
                            </div>
							<div class="form-group">
                                <?php echo form_label('Other Invoice Code', 'OtherInvoiceCode'); ?>
                                <?php echo form_input('OtherInvoiceCode',$Invoice->OtherInvoiceCode); ?>
                            </div>
							<div class="form-group">
                                <?php echo form_label('Client', 'ClientId'); ?>
                                <?php echo form_input('ClientId',$Invoice->ClientId); ?>
                            </div>
							<div class="form-group"> 
