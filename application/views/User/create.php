					...
					<div role="form">
						<div class="box-body">
							...
							<div class="form-group">
                                 ...
                                 <?php echo Ajaxdropdown('ParentId',$this->omodel->ddlUser()); ?>
                            </div>
							<div class="form-group">
                                 <?php echo form_label('Leg', 'LegId'); ?>
                                 
                                 <?php echo Ajaxdropdown('LegId',$this->omodel->ddlLeg()); ?>
                            </div>
							<div class="form-group">
                                 <?php echo form_label('Member Ship Level', 'MemberShipLevelId'); ?>
                                 
                                 <?php echo Ajaxdropdown('MemberShipLevelId',$this->omodel->ddlMemberShipLevel()); ?>
                            </div>
							<div class="form-group">
                                <?php echo form_label('Register Pin', 'RegisterPin'); ?>
                                <?php echo form_input('RegisterPin'); ?>
                            </div>
