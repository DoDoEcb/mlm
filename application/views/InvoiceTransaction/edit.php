...
<?php $modelname = "InvoiceTransaction"; ?>
					...
					<div role="form">  
						<div class="box-body">
						    <div class="form-group"> 
								 <?php echo form_hidden('Id',$InvoiceTransaction->Id); ?>
							</div>
							<div class="form-group">
                                <?php echo form_label('Transaction', 'TransactionId'); ?>
                                <?php echo form_input('TransactionId',$InvoiceTransaction->TransactionId); ?>
                            </div>
							<div class="form-group">
                                 <?php echo form_label('Invoice', 'InvoiceId'); ?> 
                                 <?php echo Ajaxdropdown('InvoiceId',$this->omodel->ddlInvoice(),$InvoiceTransaction->InvoiceId); ?>
                            </div>
