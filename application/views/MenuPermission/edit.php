					...
					<div role="form">  
						<div class="box-body">
						    <div class="form-group"> 
								 <?php echo form_hidden('Id',$MenuPermission->Id); ?>
							</div>
							<div class="form-group">
                                 <?php echo form_label('Menu', 'MenuId'); ?> 
                                 <?php echo Ajaxdropdown('MenuId',$this->omodel->ddlMenu(),$MenuPermission->MenuId); ?>
                            </div>
							<div class="form-group">
                                 <?php echo form_label('Role', 'RoleId'); ?> 
                                 <?php echo Ajaxdropdown('RoleId',$this->omodel->ddlRole(),$MenuPermission->RoleId); ?>
                            </div>
							<div class="form-group">
                                 <?php echo form_label('User', 'UserId'); ?> 
                                 <?php echo Ajaxdropdown('UserId',$this->omodel->ddlUser(),$MenuPermission->UserId); ?>
                            </div>
							<div class="form-group">
                                <?php echo form_label('Sort Order', 'SortOrder'); ?>
                                <?php echo form_input('SortOrder',$MenuPermission->SortOrder); ?>
                            </div>
