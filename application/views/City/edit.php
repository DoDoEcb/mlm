					...
					<div role="form">  
						<div class="box-body">
							...
							<div class="form-group">
                                ...
                                <?php echo form_input('Name',$City->Name); ?>
                            </div>
							<div class="form-group">
                                <?php echo form_label('Latitude', 'Latitude'); ?>
                                <?php echo form_input('Latitude',$City->Latitude); ?>
                            </div>
							<div class="form-group">
                                <?php echo form_label('Longitude', 'Longitude'); ?>
                                <?php echo form_input('Longitude',$City->Longitude); ?>
                            </div>
							<div class="form-group">
                                  <?php echo form_label('Is Active', 'IsActive'); ?>
                                  <?php echo form_checkbox('IsActive' ,true ,$City->IsActive); ?> 
                            </div>
							<div class="form-group">
                                 <?php echo form_label('State', 'StateId'); ?> 
                                 <?php echo Ajaxdropdown('StateId',$this->omodel->ddlState(),$City->StateId); ?>
                            </div>
