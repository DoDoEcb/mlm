					...
					<div role="form">  
						<div class="box-body">
						    <div class="form-group"> 
								 <?php echo form_hidden('Id',$State->Id); ?>
							</div>
							<div class="form-group">
                                <?php echo form_label('Name', 'Name'); ?>
                                <?php echo form_input('Name',$State->Name); ?>
                            </div>
							<div class="form-group">
                                <?php echo form_label('Code', 'Code'); ?>
                                <?php echo form_input('Code',$State->Code); ?>
                            </div>
							<div class="form-group">
                                  <?php echo form_label('Is Active', 'IsActive'); ?>
                                  <?php echo form_checkbox('IsActive' ,true ,$State->IsActive); ?> 
                            </div>
							<div class="form-group">
                                 <?php echo form_label('Country', 'CountryId'); ?> 
                                 <?php echo Ajaxdropdown('CountryId',$this->omodel->ddlCountry(),$State->CountryId); ?>
                            </div>
